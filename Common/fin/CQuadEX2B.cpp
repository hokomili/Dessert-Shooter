...
void CQuadEX2B::setShader(mat4 &mxModelView, mat4 &mxProjection, GLuint uiShaderHandle)
{
	...
	if( uiShaderHandle == MAX_UNSIGNED_INT) _uiProgram = InitShader("vsVtxColorEX2.glsl", "fsVtxColor.glsl");
	...
	_uiAngleLoc = glGetUniformLocation( _uiProgram, "fAngle" );
	_uiTranLoc = glGetUniformLocation( _uiProgram,  "vTranslate" );
...
void CQuadEX2B::Draw()
{
	...
	glUniform1f(_uiAngleLoc, _fAngle);
	glUniform3fv(_uiTranLoc, 1, _fTranslate);
