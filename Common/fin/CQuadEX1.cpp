...
void CQuadEX1::setShader(mat4 &mxModelView, mat4 &mxProjection, GLuint uiShaderHandle)
{
	...
	if( uiShaderHandle == MAX_UNSIGNED_INT) _uiProgram = InitShader("vsVtxColorEX1.glsl", "fsVtxColor.glsl");
	...
	_uiAxisLoc = glGetUniformLocation( _uiProgram, "iAxis" );
...
{
	glUniform1f(_uiAngleLoc,fAngle);
	glUniform1i(_uiAxisLoc,iAxis);
}
